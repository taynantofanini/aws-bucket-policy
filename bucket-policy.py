...
def buckets3_logging(listed_buckets):
    for bucket in listed_buckets:
        ...
        if "LoggingEnabled" not in bucket_logging.keys():
            ...
            print("Logging habilitado com sucesso para o bucket '{}' ".format(bucket))
        else:
            print("Logging previamente habilitado para o bucket '{}' ".format(bucket))
    print("Todos os buckets foram atualizados e estão com o 'Server Access Logging' ativos")
...
if __name__ == "__main__":
    ...
    buckets3_logging(listed_buckets)